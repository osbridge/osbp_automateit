...
"bootstrap.sh" file. Once the machine is bootstrapped, you can apply the
recipes by running "rake", or apply individual recipes using commands like
"automateit recipe/base_apache.rb".
...
repeatedly.
    ...
    different paths, you must change the paths.
